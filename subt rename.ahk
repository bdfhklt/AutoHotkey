...
Gui, Show, w800 h800, 
Gui +Resize
Gui, Add, ListView, x0 y0 w400 h740 Grid -ReadOnly gLV vLV1, n|list
Gui, Add, ListView, x400 y0 w400 h740 Grid -ReadOnly gLV vLV2, n|list
...
if(A_GuiControl == "LV1")
{
	dropFiles("LV1", A_GuiEvent)
}
return

dropFiles(LV, GuiEvent)
{
...
LV:
if(A_GuiEvent == "D" && LV_GetCount("Selected") = 1) ; 드래그 기능
{
	tmp1 := 1
